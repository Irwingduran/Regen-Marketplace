...
export default function NFTEducation({ userType, onComplete }: NFTEducationProps) {
  ...
  const slides = [
    {
      title: "¿Qué son los NFTs en Urbanika?",
      content: (
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Los NFTs en Urbanika son certificados digitales que representan tu compromiso y progreso en sostenibilidad.
  ...
  return (
    <div>
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Conoce los NFTs de Urbanika</h2>
