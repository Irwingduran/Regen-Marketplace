  ...
  return (
    <div className="text-center">
      <div className="mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4">¡Bienvenido a Urbanika! 🎉</h2>
      ...
      <div className="mt-12 p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl max-w-2xl mx-auto">
        ...
        <p className="text-sm text-gray-700">
          {isVendor
            ? `Hola ${formData.contactName || "Proveedor"}, estamos emocionados de tenerte en Urbanika. Tu compromiso con la sostenibilidad ayudará a construir un futuro más verde.`
