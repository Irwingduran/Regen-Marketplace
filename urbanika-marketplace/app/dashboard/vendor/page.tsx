...
const vendorData = {
  ...
  certifications: [
    { name: "ISO 14001", status: "verified", expiryDate: "2025-06-15" },
    { name: "Energy Star", status: "verified", expiryDate: "2024-12-20" },
    { name: "LEED Certified", status: "pending", submittedDate: "2024-01-10" },
    { name: "Carbon Neutral", status: "expired", expiryDate: "2024-01-01" },
  ],
  metrics: {
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <TabsContent value="overview" className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <NFTEvolutionCard currentLevel={vendorData.nftLevel} score={vendorData.regenScore} />
                </div>
